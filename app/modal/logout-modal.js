        ...
        <Dialog open={open} >
            <DialogContent onPointerDownOutside={closeAllModal} showCloseButton={false} className="max-w-none rounded-[24px] w-[90vw] p-0 border-0">
                ...
                <div className="p-8 w-full lg:w-lg flex flex-col items-center justify-center">
                    ...
                    <h1 className="text-[19px] font-semibold text-center mt-[24px] mb-[8px]">{t('logout_modal_title')}</h1>
                    <p className="text-[#838383] text-[13px]">{t('logout_modal_desc')}</p>
                    <form className="w-full mt-[24px]" onSubmit={(e) => {
                        ...
                        <div className="py-2 pl-1 pr-3 w-full group  rounded-full shadow-[0px_2px_0px_rgba(0,0,0,0.15)]">
                            <button
                                type="submit"
                                className="w-full group-hover:scale-105 transition-all  flex justify-center items-center gap-2 font-bold py-3 px-4 rounded-full shadow-[4px_4px_0px_0px_rgba(240,6,6,1)]  text-white bg-[#FE3939] "
                            >
                                {t("yes")}
                            </button>
                        </div>
