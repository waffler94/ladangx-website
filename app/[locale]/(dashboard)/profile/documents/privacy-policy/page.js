...
const EnglishTerms = () => {
    return (
        <div className="p-6 max-w-4xl mx-auto">
            ...
            <p className="mb-4">
                This Privacy Policy explains how we collect, use, and protect your information when you use our application or website ("Service").
            </p>
...
const MalayTerms = () => {
    return (
        <div className="p-6 max-w-4xl mx-auto">
            ...
            <p className="mb-4">
                Dasar Privasi ini menerangkan bagaimana kami mengumpul, menggunakan, dan melindungi maklumat anda apabila anda menggunakan aplikasi atau laman web kami ("Perkhidmatan").
            </p>
