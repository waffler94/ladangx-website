"use client";
import { getAutocompleteProject, getCart, getProjectDetails, searchProjects } from "@/lib/actions";
...
export function useGetCart(params = { visit_date: undefined }) {
    // Use array key so SWR differentiates by params
    const key = ["cart", params];
