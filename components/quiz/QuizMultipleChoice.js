          ...
          <div className="mt-8 animate-float text-center">
            {isCorrect ? (
              <div className="bg-green-500 text-white p-6 rounded-3xl border-b-8 border-green-700">
                <h3 className="text-3xl font-black mb-2">🎉 {t('perfect_score')}</h3>
                {/* 3. BUTTON: Next Level */}
                <button 
                  onClick={onNext} 
                  className="bg-white text-green-600 px-8 py-3 rounded-xl font-black hover:scale-105 transition-transform"
                >
              ...
              <div className="bg-rose-500 text-white p-6 rounded-3xl border-b-8 border-rose-700">
                ...
                <p className="font-bold mb-4">{t('the_correct_answer')} <br/> ...</p>
                {/* 4. BUTTON: Try Again (New Question) */}
                <button 
                  onClick={handleRetry} 
                  className="bg-white text-rose-600 px-8 py-3 rounded-xl font-black hover:scale-105 transition-transform"
                >
                  {t('try_again')} ↺
                </button>
              </div>
